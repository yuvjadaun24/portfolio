  ...
  return (
    <div className="absolute inset-0 overflow-hidden">
      ...
      >
        ...
        {/* Wave 1 (crossfade between 2 static shapes; avoids animating `d`) */}
        <motion.path
          d="M0,100 Q250,80 500,100 T1000,100 T1500,100 T2000,100 L2000,200 L0,200 Z"
          fill="url(#wave-gradient-1)"
          style={{ willChange: 'opacity' }}
          animate={{ opacity: [0.55, 0.0, 0.55] }}
          transition={{ duration: 8, repeat: Infinity, ease: 'easeInOut' }}
        />
        <motion.path
          d="M0,100 Q250,120 500,100 T1000,100 T1500,100 T2000,100 L2000,200 L0,200 Z"
          fill="url(#wave-gradient-1)"
          style={{ willChange: 'opacity' }}
          initial={{ opacity: 0.0 }}
        ...
        {/* Wave 2 (crossfade static shapes) */}
        <motion.path
          d="M0,150 Q300,130 600,150 T1200,150 T1800,150 T2400,150 L2400,250 L0,250 Z"
          fill="url(#wave-gradient-2)"
          style={{ willChange: 'opacity' }}
          animate={{ opacity: [0.45, 0.0, 0.45] }}
          transition={{ duration: 10, repeat: Infinity, ease: 'easeInOut', delay: 1 }}
        />
        <motion.path
          d="M0,150 Q300,170 600,150 T1200,150 T1800,150 T2400,150 L2400,250 L0,250 Z"
          fill="url(#wave-gradient-2)"
          style={{ willChange: 'opacity' }}
          initial={{ opacity: 0.0 }}
        ...
        {/* Wave 3 (crossfade static shapes) */}
        <motion.path
          d="M0,200 Q400,180 800,200 T1600,200 T2400,200 L2400,300 L0,300 Z"
          fill="url(#wave-gradient-1)"
          style={{ willChange: 'opacity' }}
          animate={{ opacity: [0.30, 0.0, 0.30] }}
          transition={{ duration: 12, repeat: Infinity, ease: 'easeInOut', delay: 0.5 }}
        />
        <motion.path
          d="M0,200 Q400,220 800,200 T1600,200 T2400,200 L2400,300 L0,300 Z"
          fill="url(#wave-gradient-1)"
          style={{ willChange: 'opacity' }}
          initial={{ opacity: 0.0 }}
